...
export function GitHub() {
    ...
    useEffect(() => {
        fetch('https://api.github.com/users/prasannareddychirra/repos?sort=pushed&direction=desc&per_page=3')
        ...
        <section id="github" className="py-20">
            <div className="container mx-auto max-w-6xl px-8">
                ...
                <div className="mb-12 flex flex-col items-center">
                    ...
                    <p className="mt-6 text-lg  justify-center text-gray-600 dark:text-gray-300 max-w-3xl">
